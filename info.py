...
auth_channel = environ.get('AUTH_CHANNEL', '-1001824922603 -1001761007796')
...
MELCOW_NEW_USERS = is_enabled((environ.get('MELCOW_NEW_USERS', "https://graph.org/file/72dff2b65352ba85d0a34.mp4")), True)
